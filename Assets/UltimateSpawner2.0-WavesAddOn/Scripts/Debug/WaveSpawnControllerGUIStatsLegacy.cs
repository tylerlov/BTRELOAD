...
namespace UltimateSpawner.DebugUtil
{
    public class WaveSpawnControllerGUIStatsLegacy : SpawnControllerGUIStatsLegacy
    {
        ...
        public void DisplayWaveControllerStats()
        {
            ...
            SpawnableItem targetItem = (controller.CurrentState.TargetSpawnable != null && controller.spawner != null && controller.spawner.SpawnableItems != null)
                ? controller.spawner.SpawnableItems.FindSpawnableItem(controller.CurrentState.TargetSpawnable)
                : null;

            DisplayControllerStat("Current Wave Target Spawnable", (controller.CurrentState != null) ? ((targetItem != null) ? targetItem.ItemName : "Any") : "None");
