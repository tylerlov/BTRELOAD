...
namespace MH.WaterCausticsModules
{
    ...
    public class WaterCausticsTexGenerator : MonoBehaviour
    {
        ...
        private void drawMesh(RenderTexture rt)
        {
            ...
            GL.PushMatrix();
#if UNITY_EDITOR
            var matrix = (Camera.current == null)
                ? ORTHO_MATRIX
                : ORTHO_MATRIX * Camera.current.worldToCameraMatrix.inverse;
        ...
        public class Wave
        {
            ...
            [Space(3)] [SerializeField, Range(0f, 2f)]
            private float m_fluctuation = 0.6f;
