...
namespace MH.WaterCausticsModules
{
    ...
    public class WaterCausticsEffect : MonoBehaviour
    {
        ...
        private class pID
        {
            ...
            readonly public static int _WCE_WaterSurfaceAttenOffset =
                Shader.PropertyToID("_WCE_WaterSurfaceAttenOffset");
            ...
            readonly public static int _WCECF__IntensityMainLit = Shader.PropertyToID("_WCECF__IntensityMainLit");
            readonly public static int _WCECF__Scale = Shader.PropertyToID("_WCECF__Scale");
            readonly public static int _WCECF__ColorShift = Shader.PropertyToID("_WCECF__ColorShift");
            readonly public static int _WCECF__WaterSurfaceY = Shader.PropertyToID("_WCECF__WaterSurfaceY");

            readonly public static int _WCECF__WaterSurfaceAttenOffset =
                Shader.PropertyToID("_WCECF__WaterSurfaceAttenOffset");

            readonly public static int _WCECF__WaterSurfaceAttenWide =
                Shader.PropertyToID("_WCECF__WaterSurfaceAttenWide");

            readonly public static int _WCECF__LitSaturation = Shader.PropertyToID("_WCECF__LitSaturation");
            readonly public static int _WCECF__IntensityAddLit = Shader.PropertyToID("_WCECF__IntensityAddLit");
            readonly public static int _WCECF__MulOpaqueIntensity = Shader.PropertyToID("_WCECF__MulOpaqueIntensity");
            readonly public static int _WCECF__NormalAttenPower = Shader.PropertyToID("_WCECF__NormalAttenPower");

            readonly public static int _WCECF__NormalAttenIntensity =
                Shader.PropertyToID("_WCECF__NormalAttenIntensity");

            readonly public static int _WCECF__TransparentBackside = Shader.PropertyToID("_WCECF__TransparentBackside");

            readonly public static int _WCECF__WldObjMatrixOfVolume =
                Shader.PropertyToID("_WCECF__WldObjMatrixOfVolume");

            readonly public static int _WCECF__ClipOutsideVolume = Shader.PropertyToID("_WCECF__ClipOutsideVolume");
            readonly public static int _WCECF__UseImageMask = Shader.PropertyToID("_WCECF__UseImageMask");
            readonly public static int _WCECF__CausticsTex = Shader.PropertyToID("_WCECF__CausticsTex");
            readonly public static int _WCECF__ImageMaskTex = Shader.PropertyToID("_WCECF__ImageMaskTex");
        }


        // ----------------------------------------------------------- Material Uniqueness
        static private Dictionary<Material, WaterCausticsEffect> s_matDic =
            new Dictionary<Material, WaterCausticsEffect>();
        ...
        void setMaterialValue(Material mat)
        {
            if (mat != null)
            {
                ...
                mat.SetFloat(pID._WCE_IntensityAddLit,
                    m_intensity * m_adjustAddLit * (m_useAdditionalLights ? 1f : 0f));
        ...
        {
            bool isNoTex = (m_texture == null);
            Shader.SetGlobalFloat(pID._WCECF__Scale, isNoTex ? m_scale * 0.333f : m_scale);
            Shader.SetGlobalFloat(pID._WCECF__WaterSurfaceY, m_waterSurfaceY);
            Shader.SetGlobalFloat(pID._WCECF__WaterSurfaceAttenOffset, m_waterSurfaceAttenOffset);
            Shader.SetGlobalFloat(pID._WCECF__WaterSurfaceAttenWide, m_waterSurfaceAttenWide);
            Shader.SetGlobalFloat(pID._WCECF__IntensityMainLit,
                m_intensity * m_adjustMainLit * (m_useMainLight ? 1f : 0f));
            Shader.SetGlobalFloat(pID._WCECF__IntensityAddLit,
                m_intensity * m_adjustAddLit * (m_useAdditionalLights ? 1f : 0f));
            Shader.SetGlobalVector(pID._WCECF__ColorShift, new Vector2(m_colorShiftU, m_colorShiftV) * 0.01f);
            Shader.SetGlobalFloat(pID._WCECF__LitSaturation, m_litSaturation);
            float mulOpaque = m_multiplyOpaqueColor ? m_multiplyOpaqueIntensity : 0f;
            Shader.SetGlobalFloat(pID._WCECF__MulOpaqueIntensity, mulOpaque);
            Shader.SetGlobalFloat(pID._WCECF__NormalAttenPower, m_normalAttenPower);
            Shader.SetGlobalFloat(pID._WCECF__NormalAttenIntensity, m_normalAttenIntensity);
            Shader.SetGlobalFloat(pID._WCECF__TransparentBackside, m_transparentBackside);
            Shader.SetGlobalMatrix(pID._WCECF__WldObjMatrixOfVolume, transform.worldToLocalMatrix);
            Shader.SetGlobalInt(pID._WCECF__ClipOutsideVolume, System.Convert.ToInt32(m_clipOutsideVolume));
            Shader.SetGlobalTexture(pID._WCECF__CausticsTex, isNoTex ? m_noTexture : m_texture);
            bool useImgMask = (m_useImageMask && m_imageMaskTexture);
            Shader.SetGlobalInt(pID._WCECF__UseImageMask, System.Convert.ToInt32(useImgMask));
            Shader.SetGlobalTexture(pID._WCECF__ImageMaskTex, useImgMask ? m_imageMaskTexture : null);
        }
        ...
        private bool isXRMultiPass => (XRSettings.enabled &&
