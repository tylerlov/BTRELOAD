...
namespace Koenigz.PerfectCulling
{
    public class PerfectCullingBakerNativeWin64 : PerfectCullingBaker
    {
        ...
        public override string RendererName => "Native (OpenGL)";
            ...
            : base(perfectCullingBakeSettings)
        {
            ...
            // Split
            {
                ...
                for (int indexCombineInstance = 0; indexCombineInstance < meshFilters.Count; ++indexCombineInstance)
                {
                    ...
                    {
                        PerfectCullingLogger.LogWarning($"Number of materials ({mats.Length}) doesn't match number of sub-meshes ({colorMesh.subMeshCount}) for {renderer.name}.", renderer.gameObject);
                    }
            ...
            m_pipeStreamWriter.Write((int)(PerfectCullingSettings.Instance.bakeCameraFarClipPlane * 1000.0));
        }
