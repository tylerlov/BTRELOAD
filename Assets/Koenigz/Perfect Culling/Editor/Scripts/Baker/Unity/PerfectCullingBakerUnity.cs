...
namespace Koenigz.PerfectCulling
{
    ...
    {
        public override string RendererName => "Unity";
            ...
            base(perfectCullingBakeSettings)
        {
            ...
            {
                PerfectCullingLogger.LogError("Unable to locate Perfect Culling Compute Shader. Did you move any of the assets to a different location?");
        ...
        void PrepareScene()
        {
            ...
            // Disabling this code because it seems to just cause problems...
#if false
...
#pragma warning restore 162
        ...
        Camera SpawnCamera()
        {
            ...
            cam.farClipPlane = PerfectCullingSettings.Instance.bakeCameraFarClipPlane;
