...
namespace Koenigz.PerfectCulling
{
    ...
    {
        [UnityEditor.MenuItem("Perfect Culling/Bake/Bake Manager")]
        private static void BakeManager()
        {
            PerfectCullingBakingManagerWindow win = EditorWindow.GetWindow<PerfectCullingBakingManagerWindow>();
            win.titleContent = new GUIContent("Baking Manager");
            win.Show();
        }
        ...
        {
            PerfectCullingLogger.Log("Single scene bake.");
        ...
        {
            PerfectCullingLogger.Log("Multi scene bake.");
