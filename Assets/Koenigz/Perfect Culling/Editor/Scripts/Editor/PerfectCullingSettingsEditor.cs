...
namespace Koenigz.PerfectCulling
{
    ...
    {
        static readonly string PerfectCullingDisplayVersion = "1.2.6.1";
        
#pragma warning disable 414
        private static readonly int PerfectCullingVersionCode = 1261;
#pragma warning restore 414
        ...
        SerializedProperty bakeCameraFarClipPlane;
        ...
        private void OnEnable()
        {
            ...
            bakeCameraFarClipPlane = so.FindProperty("bakeCameraFarClipPlane");
        ...
        public override void OnInspectorGUI()
        {
            ...
            so.Update();
            {
                ...
                string rendererName = "Unity";

#if UNITY_EDITOR_WIN
                if (!useUnityForRendering.boolValue)
                {
                    if (useNativeVulkanForRendering.boolValue)
                    {
                        rendererName = "Vulkan";
                    }
                    else
                ...
                EditorGUILayout.HelpBox($"Active renderer: {rendererName}", MessageType.Info);
                ...
                EditorGUILayout.PropertyField(bakeCameraFarClipPlane,
                    new GUIContent("Rendering Distance (Far Clip Plane)"));
