...
namespace Koenigz.PerfectCulling
{
    public static class pc_renderer
    {
        ...
        private delegate void DelBeginRender(Vector3[] samplingPositions, int samplingPosCount,
            NativeMeshRenderers[] nativeMeshRenderers, int nativeMeshRenderersCount);
        ...
        public static void Render(pc_renderer_settings settings)
        {
            ...
            settings.NativeLibPath =
                UnityEditor.AssetDatabase.GetAssetPath(PerfectCullingResourcesLocator.Instance.LookupNativeLib());
        ...
        private static void ThreadMain(object obj)
        {
            ...
            BeginRender(settings.SamplingPositions, settings.SamplingPositions.Length, settings.NativeMeshRenderers,
                settings.NativeMeshRenderers.Length);
