	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 Indirect_Diffuse644_g1 = ( ( ( ( localAdditionalLightsHalfLambert14x149_g61278 + bakedGI607_g1 ) * _IndirectDiffuse ) * Occlusion435_g1 ) * ( 1.0 ) );
...
ASEEND*/
//CHKSM=1B4EE4278FD8535C040C1FCA9D8D5FA8D77BEB68