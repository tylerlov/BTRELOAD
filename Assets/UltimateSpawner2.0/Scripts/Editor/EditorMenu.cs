...
namespace UltimateSpawner.Editor
{
    public class EditorMenu
    {
        ...
        [MenuItem(componentMenuPath + "Despawn On Viewport Exit", false, 87)]
        public static void CreateDespawnOnViewportExit()
        {
            AttachComponentToSelection<DespawnOnViewportExit>();
        }
