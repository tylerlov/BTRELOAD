...
namespace UltimateSpawner.Spawning
{
    ...
    public enum SpawnMode
    {
        ...
        /// <summary>
        /// Cause all associated spawners to spawn an item.
        /// </summary>
        All,
    }
    ...
    public class SpawnerGroup : Spawner
    {
        ...
        /// If the <see cref="spawnSelectionMode"/> is set to <see cref="SpawnMode.All"/>, the returned value will be the transform for the last item that was spawned.
        /// </summary>
        ...
        public override Transform Spawn(SpawnableItemRef itemRef = null)
        {
            ...
            // Check for all
            if(spawnSelectionMode == SpawnMode.All)
            {
                // Get all available
                ...
                // Spawn all
                foreach(Spawner nextSpawner in available)
                {
                    result = nextSpawner.Spawn(itemRef);
                }
                return result;
            }
        ...
        /// If the current <see cref="spawnSelectionMode"/> is set to <see cref="SpawnMode.All"/>, this method will fail with a warning message, since this method can only deal with single item spawn requests.
        /// </summary>
        ...
        public override bool Spawn(Transform toSpawn)
        {
            ...
            if (spawnSelectionMode == SpawnMode.All)
            {
                Debug.LogWarning("Failed to spawn - Cannot spawn the specified transform because the spawn mode is set to 'All'");
                return false;
            }
