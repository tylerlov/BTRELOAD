...
namespace FIMSpace.FOptimizing
{
    ...
    {
        public static bool SomethingNeedToBeSaved(FOptimizer_Base optimizer)
        {
            ...
            List<FComponentLODsController> haveNotSaved = CheckIfOptimizerHaveUnsavedLODs(optimizer, true);
        ...
        public static void SaveLackingLODsAsSubAssets(FOptimizer_Base optimizer)
        {
            ...
            // Checking if all not shared assets are saved in prefab file
            // If any of them is not saved we must perform saving
            List<FComponentLODsController> haveNotSaved = CheckIfOptimizerHaveUnsavedLODs(optimizer);
        ...
        public static void RemoveLODControllerSubAssets(FComponentLODsController controller, bool onlySubSettings = false)
        {
            ...
            FOptimizer_LODSettings lodSet = controller.LODSet;
        ...
        public static void ClearPrefabFromUnusedOptimizersSubAssets(GameObject prefab)
        {
            ...
            List<Object> toRemove = FOptimizer_Cleaner.CheckForLeftovers(prefab, false);
        ...
        public static void OnValidateEnds(FOptimizer_Base optimizer)
        {
