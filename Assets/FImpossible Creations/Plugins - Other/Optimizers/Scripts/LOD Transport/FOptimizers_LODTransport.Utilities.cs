...
namespace FIMSpace.FOptimizing
{
    ...
    /// </summary>
    public static partial class FOptimizers_LODTransport
    {
        /// <summary>
        ...
        public static List<FComponentLODsController> CheckIfOptimizerHaveUnsavedLODs(FOptimizer_Base optimizer, bool checkIfAny = false)
        {
            ...
            List<FComponentLODsController> haveUnsaved = new List<FComponentLODsController>();

            for (int o = 0; o < optimizer.ToOptimize.Count; o++)
            {
                // LODs controller for one component under optimization by optimizer
                FComponentLODsController lodsController = optimizer.ToOptimize[0];
                FOptimizer_LODSettings lodSettings = lodsController.LODSet;
                List<FLOD_Base> lods = lodSettings.LevelOfDetailSets;
        ...
        /// </summary>
        public static void SaveOptimizerLODDataInPrefab(FOptimizer_Base optimizer, Object prefab)
        {
        ...
        /// </summary>
        public static void SaveLODSetInAsset(FComponentLODsController controller, Object asset, Object[] assetSubAssets)
        {
            ...
            if (lodSetCheckable)
            {
                ...
                {
                    FLOD_Base lod = controller.LODSet.LevelOfDetailSets[i];
        ...
        /// </summary>
        public static void SaveLODSetInAsset(FComponentLODsController controller, Object asset)
        {
        ...
        /// </summary>
        public static void SyncSceneOptimizerWithPrefab(FOptimizer_Base optimizer, FComponentLODsController controller)
        {
            ...
            if (prefab)
            {
                try
                {
                    ...
                    if (o)
                    {
                        FOptimizer_Base prefabOptim = null;
                        ...
                        foreach (Transform childInDepth in o.GetComponentsInChildren<Transform>())
                        {
                            ...
                            var Opts = childInDepth.GetComponents<FOptimizer_Base>();
                        ...
                        if (prefabOptim)
                        {
                            ...
                            {
                                FComponentLODsController lodC = prefabOptim.ToOptimize[i];
        ...
        /// to created prefab
        /// </summary>
        public static void SaveLODSettingsFromSceneOptimizer(FComponentLODsController controller)
        {
            FOptimizer_Base optimizer = controller.GetOptimizer();
            ...
            {
                FOptimizer_Base[] sceneOpts = GameObject.FindObjectsOfType<FOptimizer_Base>();
