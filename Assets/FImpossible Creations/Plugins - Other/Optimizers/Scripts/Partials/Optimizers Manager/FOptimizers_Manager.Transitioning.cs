...
namespace FIMSpace.FOptimizing
{
    public partial class FOptimizers_Manager
    {
        ...
        public void TransitionTo(FOptimizer_Base optimizer, int targetLODLevel, float duration = 0f)
        {
            ...
            FOptimizers_Transitioning helper = null; // If we are already transitioning provided LODs controller we will find it  
            ...
            {
                helper = new FOptimizers_Transitioning(optimizerId, optimizer, targetLODLevel, duration, transitioning.Count);
