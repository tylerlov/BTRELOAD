    ...
    public abstract partial class FOptimizer_Base
    {
        ...
        private void InitDynamicOptimizer(bool justDynamic)
        {
            ...
            if (manager == null)
            {
                ...
                if (FOptimizers_Manager.MainCamera) TargetCamera = FOptimizers_Manager.MainCamera.transform;
            }

            if (justDynamic) FOptimizers_Manager.Get.RegisterNotContainedDynamicOptimizer(this, true);
