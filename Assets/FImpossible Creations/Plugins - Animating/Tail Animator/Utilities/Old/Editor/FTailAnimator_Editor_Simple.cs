...
namespace FIMSpace.FTail
{
    ...
    public class FTailAnimator_Editor : FTailAnimator_Editor_Base
    {
        ...
        protected override void ConvertToV2(FTail_AnimatorBase oldTail, TailAnimator2 n)
        {
            ...
            FTail_Animator tailSimple = target as FTail_Animator;

            n.UseWaving = tailSimple.UseWaving;
            n.WavingAxis = tailSimple.WavingAxis;
            n.WavingRange = tailSimple.WavingRange;
            n.WavingSpeed = tailSimple.WavingSpeed;
            n.WavingType = tailSimple.WavingType == FTail_Animator.FEWavingType.Advanced ? TailAnimator2.FEWavingType.Advanced : TailAnimator2.FEWavingType.Simple;
            n.AlternateWave = tailSimple.AlternateWave;
            n.DetachChildren = tailSimple.DisconnectTransforms;
            n.UpdateAsLast = tailSimple.QueueToLastUpdate;
            n.CosinusAdd = tailSimple.CosinusAdd;
        }
