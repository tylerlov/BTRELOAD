    ...
    public class HotkeyEvent : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Initialize()
        {
            ...
            if (useLocalization)
            {
             ...
             if (useSounds)
        {
            // Assuming you have a method to play FMOD events
            onHotkeyPress.AddListener(delegate { FMODUnity.RuntimeManager.PlayOneShot(UIManagerAudio.instance.UIManagerAsset.clickSound); });
        }
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (useSounds) { FMODUnity.RuntimeManager.PlayOneShot(UIManagerAudio.instance.UIManagerAsset.clickSound); }
        ...
        {
            if (useSounds) { FMODUnity.RuntimeManager.PlayOneShot(UIManagerAudio.instance.UIManagerAsset.hoverSound); }
        ...
        IEnumerator SetHighlight()
        {
         ...
         private void PlayFMODSound(EventReference soundEvent)
    {
