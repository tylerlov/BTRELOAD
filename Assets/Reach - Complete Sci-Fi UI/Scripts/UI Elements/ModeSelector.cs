...
namespace Michsky.UI.Reach
{
    ...
    public class ModeSelector : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, ISubmitHandler
    {
        ...
        public EventReference modeSelectClickSFX;
        public EventReference modeSelectHoverSFX;
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (useSounds && !modeSelectClickSFX.IsNull) { RuntimeManager.PlayOneShot(modeSelectClickSFX); }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            if (useSounds && !modeSelectHoverSFX.IsNull) { RuntimeManager.PlayOneShot(modeSelectHoverSFX); }
