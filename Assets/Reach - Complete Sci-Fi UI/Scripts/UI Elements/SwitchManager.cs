...
namespace Michsky.UI.Reach
{
    public class SwitchManager : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, ISubmitHandler
    {
        ...
        public EventReference switchOnSFX;
        public EventReference switchOffSFX;
        public EventReference hoverSoundSFX;
        public EventReference clickSoundSFX;
        ...
        public void AnimateSwitch()
        {
            ...
            if (isOn)
            {
                ...
                if (useSounds && !switchOffSFX.IsNull) { RuntimeManager.PlayOneShot(switchOffSFX); }
            ...
            else
            {
                ...
                if (useSounds && !switchOnSFX.IsNull) { RuntimeManager.PlayOneShot(switchOnSFX); }
       ...
       public void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (useSounds && !clickSoundSFX.IsNull)
            {
                RuntimeManager.PlayOneShot(clickSoundSFX);
            }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            if (useSounds && !hoverSoundSFX.IsNull)
            {
                RuntimeManager.PlayOneShot(hoverSoundSFX);
            }
