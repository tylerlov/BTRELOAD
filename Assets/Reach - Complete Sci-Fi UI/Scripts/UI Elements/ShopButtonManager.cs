...
namespace Michsky.UI.Reach
{
    ...
    public class ShopButtonManager : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, ISubmitHandler
    {
        ...
        public EventReference buttonHoverSFX;
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (useSounds && !buttonClickSFX.IsNull) { RuntimeManager.PlayOneShot(buttonClickSFX); }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            if (useSounds && !buttonHoverSFX.IsNull) { RuntimeManager.PlayOneShot(buttonHoverSFX); }
