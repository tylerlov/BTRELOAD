...
using TMPro;
using FMODUnity; // Added FMODUnity namespace
...
namespace Michsky.UI.Reach
{
    ...
    public class SliderManager : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler
    {
        ...
        // Added FMOD EventReferences for hover and click sounds
        public EventReference sliderHoverSound;
        public EventReference sliderClickSound;
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            if (useSounds) 
            {
                // Play the hover sound using FMOD
                RuntimeManager.PlayOneShot(sliderHoverSound);
            }
