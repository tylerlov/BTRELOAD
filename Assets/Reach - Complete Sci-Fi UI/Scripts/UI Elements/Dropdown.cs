...
namespace Michsky.UI.Reach
{
    public class Dropdown : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, ISubmitHandler
    {
        ...
        public EventReference dropdownClickSFX;
        public EventReference dropdownHoverSFX;
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (useSounds && !dropdownClickSFX.IsNull) { RuntimeManager.PlayOneShot(dropdownClickSFX); }
        ...
        {
            if (!isInteractable) { return; }
            if (useSounds && !dropdownHoverSFX.IsNull) { RuntimeManager.PlayOneShot(dropdownHoverSFX); }
