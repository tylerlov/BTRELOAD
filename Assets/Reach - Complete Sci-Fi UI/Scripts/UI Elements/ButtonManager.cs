...
namespace Michsky.UI.Reach
{
    ...
    public class ButtonManager : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, ISubmitHandler
    {
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
           ...
           if (useSounds) 
            {
                FMODUnity.RuntimeManager.PlayOneShot(UIManagerAudio.instance.UIManagerAsset.clickSound);
            }
        ...
        if (useSounds) 
            {
                FMODUnity.RuntimeManager.PlayOneShot(UIManagerAudio.instance.UIManagerAsset.hoverSound);
            }
