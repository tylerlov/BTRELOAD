...
namespace Michsky.UI.Reach
{
    ...
    public class NotificationManager : MonoBehaviour
    {
        ...
        public EventReference customSFX; // Changed from AudioClip to EventReference

        // Resources
        [SerializeField] private Animator itemAnimator;
        [SerializeField] private Image iconObj;
        [SerializeField] private TextMeshProUGUI textObj;
        [SerializeField] private StudioEventEmitter fmodEventEmitter; // Add FMOD's StudioEventEmitter
        ...
        public void ExpandNotification()
        {
            ...
            if (!customSFX.IsNull) 
            { 
                RuntimeManager.PlayOneShot(customSFX, transform.position); 
            }
            else if (UIManagerAudio.instance != null && !UIManagerAudio.instance.UIManagerAsset.notificationSound.IsNull) 
            { 
                RuntimeManager.PlayOneShot(UIManagerAudio.instance.UIManagerAsset.notificationSound, transform.position); 
            }
