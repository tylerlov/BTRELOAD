...
namespace BehaviorDesigner.Runtime.Tactical.AstarPathfindingProject.Tasks
{
    ...
    [TaskDescription("Chases the target in cycles, maintaining set distances before finally attempting to touch")]
    ...
    public class CyclingChargeAndExplode : IAstarAITacticalGroup
    {
