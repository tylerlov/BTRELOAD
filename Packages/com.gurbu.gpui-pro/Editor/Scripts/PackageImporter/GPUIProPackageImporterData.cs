...
namespace GPUInstancerPro
{
    public class GPUIProPackageImporterData : ScriptableObject
    {
        ...
        private string GetExternalImportedDataPath()
        {
            ...
            if (importedDataFolder != null)
                folderPath = AssetDatabase.GetAssetPath(importedDataFolder);
            folderPath += "/";
            if (!string.IsNullOrEmpty(importedDataSubFolder))
                folderPath += importedDataSubFolder;
