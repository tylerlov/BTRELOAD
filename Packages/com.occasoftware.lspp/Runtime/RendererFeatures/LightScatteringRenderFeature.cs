    ...
    public class LightScatteringRenderFeature : ScriptableRendererFeature
    {
        class LightScatteringRenderPass : ScriptableRenderPass
        {
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                // Setup Merge Target
                RenderingUtils.ReAllocateHandleIfNeeded(ref mergeRT, descriptor, FilterMode.Point, TextureWrapMode.Clamp, name: mergeRtId);

                // Setup Light Scatter Target
                descriptor.width = descriptor.width >> 1;
                descriptor.height = descriptor.height >> 1;
                RenderingUtils.ReAllocateHandleIfNeeded(ref lightScatteringRT, descriptor, FilterMode.Point, TextureWrapMode.Clamp, name: lightScatterRtId);
                ...
                RenderingUtils.ReAllocateHandleIfNeeded(ref occluderRT, occluderDescriptor, FilterMode.Point, TextureWrapMode.Clamp, name: occluderRtId);
            }
